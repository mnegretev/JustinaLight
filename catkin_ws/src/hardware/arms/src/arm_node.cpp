...
bool get_current_position(dynamixel::GroupBulkRead& groupBulkRead, std::vector<int>& ids, std::vector<int>& current_positions)
{
...
std::vector<double> positions_bit_to_radians(std::vector<int>& positions_bits, std::vector<int>& centers, std::vector<int>& directions)
{
...
int main(int argc, char **argv)
{
    ...
    {
        std::cout<<prompt<<"Missing servo directions. Specifying servo moving directions with param 'servo_arm_directions' is mandatory."<<std::endl;
        correct_params = false;
    }
    ...
    {
        std::cout<<prompt<<"Missing grip directions.Specifying gripper moving directions with param 'servo_gripper_directions' is mandatory."<<std::endl;
        correct_params = false;
    }
    ...
    std::vector<int> servo_ids        = servo_arm_ids;
    std::vector<int> servo_zeros      = servo_arm_zeros;
    std::vector<int> servo_directions = servo_arm_directions;
    ...
    if(!get_current_position(groupBulkRead, servo_ids, current_position_bits))
    {
    ...
    joint_states.position = positions_bit_to_radians(current_position_bits, servo_zeros, servo_directions);
