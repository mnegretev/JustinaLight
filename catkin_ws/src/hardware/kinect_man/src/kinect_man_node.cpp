...
bool kinectRgbd_callback(hardware_msgs::GetRgbd::Request &req, hardware_msgs::GetRgbd::Response &resp)
{
    if(!use_bag)
    {
...
bool robotRgbd_callback(hardware_msgs::GetRgbd::Request &req, hardware_msgs::GetRgbd::Response &resp)
{
    if(!use_bag)
    {
        initialize_rosmsg(resp.point_cloud, 640, 480, "kinect_link");
...
bool robotRgbdDownsampled_callback(hardware_msgs::GetRgbd::Request &req, hardware_msgs::GetRgbd::Response &resp)
{
...
bool kinectRgbdDownsampled_callback(hardware_msgs::GetRgbd::Request &req, hardware_msgs::GetRgbd::Response &resp)
{
    sensor_msgs::PointCloud2 msgCloudKinect;
    initialize_rosmsg(msgCloudKinect, 640, 480, "kinect_link");
    int widthDownSample = (int) (640 / downsample_by);
